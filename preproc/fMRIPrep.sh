...
# fmriprep-140
singularity run --cleanenv -B /media/veracrypt2/MRI_img/pnTTC/preproc/test_fmriprep_2:${HOME}/data /data/applications/fmriprep-140.simg ${HOME}/data/input ${HOME}/data/output participant --work-dir ${HOME}/data/output/work --fs-license-file ${HOME}/data/log/license.txt --notrack --template-resampling-grid='2mm' --ignore fieldmaps --use-syn-sdc --use-aroma --output-space T1w template --bold2t1w-dof=6