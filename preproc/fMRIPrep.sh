...
# 41_c1_1_2
singularity run --cleanenv -B /media/veracrypt2/MRI/pnTTC/Preproc/41_c1_1_2_fmriprep:${HOME}/data /data/applications/fmriprep-132.simg ${HOME}/data/input ${HOME}/data/output participant --work-dir ${HOME}/data/output/work --fs-license-file ${HOME}/data/log/license.txt --notrack --template-resampling-grid='2mm' --use-aroma --output-space T1w template --bold2t1w-dof=6 && echo -e "Subject: Automatic Notification\n\nAutomatic notification of analysis completion.\n\nAnalysis: 41_c1_1_2_fmriprep\nStart time: 20190415_2030" | sendmail atirom.umusus@gmail.com
...
# 41_c1_2_2
singularity run --cleanenv -B /media/veracrypt2/MRI/pnTTC/Preproc/41_c1_2_2_fmriprep:${HOME}/data /data/applications/fmriprep-132.simg ${HOME}/data/input ${HOME}/data/output participant --work-dir ${HOME}/data/output/work --fs-license-file ${HOME}/data/log/license.txt --notrack --template-resampling-grid='2mm' --use-aroma --output-space T1w template --bold2t1w-dof=6 && echo -e "Subject: Automatic Notification\n\nAutomatic notification of analysis completion.\n\nAnalysis: 41_c1_2_2_fmriprep\nStart time: 20190415_2030" | sendmail atirom.umusus@gmail.com
