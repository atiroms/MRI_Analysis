...
## 
fmriprep-docker --fs-license-file /usr/local/freesurfer/license.txt --notrack --template-resampling-grid '2mm' --write-graph --use-aroma --resource-monitor /media/veracrypt1/MRI/pnTTC/BIDS/test_2sub/Nifti2_fmriprep1 /media/veracrypt1/MRI/pnTTC/BIDS/test_2sub/fMRIPrep_output_1

fmriprep-docker --fs-license-file /usr/local/freesurfer/license.txt --notrack --template-resampling-grid '2mm' --write-graph --use-aroma --resource-monitor /media/veracrypt1/MRI/pnTTC/BIDS/test_2sub/Nifti2_fmriprep2 /media/veracrypt1/MRI/pnTTC/BIDS/test_2sub/fMRIPrep_output_2