...
param_corr_clin<-list(
  ...
  "list_model"=list("1&2" =list("wave"=c(1,2),"force_long"=F,
                                "mod"="test ~ tanner","term_pred"="tanner"),
                    "1"   =list("wave"=1,     "force_long"=F,
                                "mod"="test ~ tanner","term_pred"="tanner"),
                    "2"   =list("wave"=2,     "force_long"=F,
                                "mod"="test ~ tanner","term_pred"="tanner"),
                    "diff"=list("wave"=c(1,2),"force_long"=T,
                                "mod"="diff_test ~ diff_tanner","term_pred"="diff_tanner")),
  ...
  "list_var_basic"=list("age"   =list("1"="W1_Age_at_MRI", "2"="W2_Age_at_MRI", "label"="Age"),
                        "sex"   =list("1"="Sex",           "2"="Sex",           "label"="Sex")),
  
  "list_var_tanner"=list("max"    =list("1"="W1_Tanner_Max_wavemax", "2"="W2_Tanner_Max_wavemax", "label"="Tanner stage (max)"),
  ...
  "list_var_test"=list("wisc_pc"     =list("1"="W1_WISC_PC",       "2"= "W2_WISC_PC",       "label"="WISC Picture Completion"),
                       "wisc_if"     =list("1"="W1_WISC_IF",       "2"= "W2_WISC_IF",       "label"="WISC Information"),
                       "wisc_ds"     =list("1"=NULL,               "2"= "W2_WISC_DS",       "label"="WISC Digit Span"),
                       "wisc_cd"     =list("1"=NULL,               "2"= "W2_WISC_CD",       "label"="WISC Coding"),
                       "cbcl_g1"     =list("1"="W1_CBCL_G1",       "2"= "W2_CBCL_G1",       "label"="CBCL Withdrawn/Depressed"),
                       "cbcl_g2"     =list("1"="W1_CBCL_G2",       "2"= "W2_CBCL_G2",       "label"="CBCL Somatic Complaints"),
                       "cbcl_g3"     =list("1"="W1_CBCL_G3",       "2"= "W2_CBCL_G3",       "label"="CBCL Anxious/Depressed"),
                       "cbcl_g4"     =list("1"="W1_CBCL_G4",       "2"= "W2_CBCL_G4",       "label"="CBCL Attention Problems"),
                       "cbcl_g5"     =list("1"="W1_CBCL_G5",       "2"= "W2_CBCL_G5",       "label"="CBCL Social Problems"),
                       "cbcl_g6"     =list("1"="W1_CBCL_G6",       "2"= "W2_CBCL_G6",       "label"="CBCL Thought Problems"),
                       "cbcl_g7"     =list("1"="W1_CBCL_G7",       "2"= "W2_CBCL_G7",       "label"="CBCL Rule-breaking Behavior"),
                       "cbcl_g8"     =list("1"="W1_CBCL_G8",       "2"= "W2_CBCL_G8",       "label"="CBCL Aggressive Behavior"),
                       "cbcl_int"    =list("1"="W1_CBCL_Int",      "2"= "W2_CBCL_Int",      "label"="CBCL Internalizing Score"),
                       "cbcl_ext"    =list("1"="W1_CBCL_Ext",      "2"= "W2_CBCL_Ext",      "label"="CBCL Externalizing Score"),
                       ...
                       "wisc_pc_std" =list("1"="W1_WISC_PC_Score", "2"= "W2_WISC_PC_Score", "label"="WISC Picture Completion (std)"),
                       "wisc_if_std" =list("1"="W1_WISC_IF_Score", "2"= "W2_WISC_IF_Score", "label"="WISC Information (std)"),
                       "wisc_ds_std" =list("1"=NULL,               "2"= "W2_WISC_DS_Score", "label"="WISC Digit Span (std)"),
                       "wisc_cd_std" =list("1"=NULL,               "2"= "W2_WISC_CD_Score", "label"="WISC Coding (std)"),
                       "cbcl_g1_std" =list("1"="W1_CBCL_G1_Score", "2"= "W2_CBCL_G1_Score", "label"="CBCL Withdrawn/Depressed (std)"),
                       "cbcl_g2_std" =list("1"="W1_CBCL_G2_Score", "2"= "W2_CBCL_G2_Score", "label"="CBCL Somatic Complaints (std)"),
                       "cbcl_g3_std" =list("1"="W1_CBCL_G3_Score", "2"= "W2_CBCL_G3_Score", "label"="CBCL Anxious/Depressed (std)"),
                       "cbcl_g4_std" =list("1"="W1_CBCL_G4_Score", "2"= "W2_CBCL_G4_Score", "label"="CBCL Attention Problems (std)"),
                       "cbcl_g5_std" =list("1"="W1_CBCL_G5_Score", "2"= "W2_CBCL_G5_Score", "label"="CBCL Social Problems (std)"),
                       "cbcl_g6_std" =list("1"="W1_CBCL_G6_Score", "2"= "W2_CBCL_G6_Score", "label"="CBCL Thought Problems (std)"),
                       "cbcl_g7_std" =list("1"="W1_CBCL_G7_Score", "2"= "W2_CBCL_G7_Score", "label"="CBCL Rule-breaking Behavior (std)"),
                       "cbcl_g8_std" =list("1"="W1_CBCL_G8_Score", "2"= "W2_CBCL_G8_Score", "label"="CBCL Aggressive Behavior (std)"),
                       "cbcl_int_std"=list("1"="W1_CBCL_Int_Score","2"= "W2_CBCL_Int_Score","label"="CBCL Internalizing Score (std)"),
                       "cbcl_ext_std"=list("1"="W1_CBCL_Ext_Score","2"= "W2_CBCL_Ext_Score","label"="CBCL Externalizing Score (std)"))
...
param_sex_diff_fc<-list(
  ...
  "list_term"=list("s" =list("title"="Sex effect","var_exp"="sex2"),
                   ...
                   "a1"=list("title"="1st wave Age","var_exp"="ses1_age"),
  ...
  "param_nbs"=list("tfnbs"=F,
                   "param_tfnbs"=list("e"=0.4,"h"=3.0,"n_thresh_h"=100),
                   "list_term"=list(list("term_perm"="s_perm","term_detect"=c("s","sxd"))),
                   "p_perm_threshold"=0.05,
                   #"n_perm"=1000),
                   #"n_perm"=100),
                   #"n_perm"=20),
