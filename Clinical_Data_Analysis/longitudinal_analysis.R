...
clinical_data_W2 <- clinical_data[which(clinical_data$W2_T1QC==1 & !is.na(clinical_data$W2_Tanner_Max)),c("ID_pnTTC","W2_Age_at_MRI_dummy","W2_Tanner_Max")]

longitudinal_data <- rbind(data.frame(ID_pnTTC=clinical_data_W1$ID_pnTTC,Wave=1,Age_at_MRI=clinical_data_W1$W1_Age_at_MRI,Tanner_Max=clinical_data_W1$W1_Tanner_Max),data.frame(ID_pnTTC=clinical_data_W2$ID_pnTTC,Wave=2,Age_at_MRI=clinical_data_W2$W2_Age_at_MRI_dummy,Tanner_Max=clinical_data_W2$W2_Tanner_Max))
