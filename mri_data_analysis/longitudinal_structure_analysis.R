...
list_covar<-list(list("key_src"="W1_Tanner_Max","key_dst"="tanner_max"),
                 list("key_src"="W1_Age_at_MRI","key_dst"="W2_Tanner_Max"))

#key_global_covar<-"BrainSegVolNotVent"
key_global_covar<-"eTIV"

subset_subj <- list("w1"=list(list("key"="W1_T1QC_new_mild","value"=1),list("key"="Sex","value"=1)),
                    "w2"=list(list("key"="W2_T1QC_new_mild","value"=1),list("key"="Sex","value"=1)))
