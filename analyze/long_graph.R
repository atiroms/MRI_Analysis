...
list_mod_diff <- list("ld"="value ~ diff_age + diff_testo",
                      "ldm"="value ~ diff_age + diff_testo + mean_testo",
                      "ad"="value ~ s(diff_age,k=3) + s(diff_testo,k=3)",
                      "adm"="value ~ s(diff_age,k=3) + s(mean_testo,k=3) + s(diff_testo,k=3)")
list_graph_diff <-list("d(h)"=list("title"="Testosterone diff effect","x_axis"="diff_testo",
                                   "smooth"=list("Male"=list("fix"=list("sex"=1),"color"="steelblue2","alpha"=1,"ribbon"=T),
                                                 "Female"=list("fix"=list("sex"=2),"color"="lightcoral","alpha"=1,"ribbon"=T)),
                                   "point"=list("Male"=list("subset"=list("sex"=1),"color"="steelblue2","alpha"=1),
                                                "Female"=list("subset"=list("sex"=2),"color"="lightcoral","alpha"=1))),
                       "m(h)"=list("title"="Testosterone mean effect","x_axis"="mean_testo",
                                   "smooth"=list("Male"=list("fix"=list("sex"=1),"color"="steelblue2","alpha"=1,"ribbon"=T),
                                                 "Female"=list("fix"=list("sex"=2),"color"="lightcoral","alpha"=1,"ribbon"=T)),
                                   "point"=list("Male"=list("subset"=list("sex"=1),"color"="steelblue2","alpha"=1),
                                                "Female"=list("subset"=list("sex"=2),"color"="lightcoral","alpha"=1))))
