...
# GLMM/GAMM of FC =================================
#**************************************************
gamm_fc_core<-function(paths,data_fc,atlas,param,list_covar,list_mod,list_term,idx_var,
...
gamm_fc<-function(param=param_gamm_fc){
  print("Starting gamm_fc().")
  nullobj<-func_createdirs(paths,str_proc="gamm_fc()",copy_log=T,list_param=param)
  memory.limit(1000000)
  
  # Loop over atlases
  for (atlas in param$list_atlas){
    print(paste("Preparing FC data: ",atlas,sep=""))
    data_fc<-prep_data_fc2(paths,atlas,param$key_group,list_wave=c("1","2"),include_grp=T,
    ...
    for (idx_var in names(param$list_tanner)){
      ...
      gamm_fc_core(paths,data_fc,atlas,param,list_covar,
